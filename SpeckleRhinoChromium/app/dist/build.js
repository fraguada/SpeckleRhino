...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Api_js__ = __webpack_require__(39);
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
  ...
  getters: {
    allAccounts: function allAccounts(state) {
      return state.accounts;
    },
    getAccountByIndex: function getAccountByIndex(state) {
      return function (index) {
        return state.accounts[index];
      };
    },
    allReceivers: function allReceivers(state) {
      return state.receivers;
    }
  },
  actions: {
    getAllAccounts: function getAllAccounts(_ref) {
      var commit = _ref.commit;

      __WEBPACK_IMPORTED_MODULE_2__Api_js__["a" /* default */].getAccounts(function (accounts) {
        commit('RECEIVE_ACCOUNTS', { accounts: accounts });
      });
    },
    getAllReceivers: function getAllReceivers(_ref2) {
      var commit = _ref2.commit;

      console.log('woa');
      __WEBPACK_IMPORTED_MODULE_2__Api_js__["a" /* default */].getReceivers(function (receivers) {
        commit('RECEIVE_RECEIVERS', { receivers: receivers });
      });
    }
  },
  mutations: {
    RECEIVE_ACCOUNTS: function RECEIVE_ACCOUNTS(state, _ref3) {
      var accounts = _ref3.accounts;

      state.accounts = accounts;
    },
    RECEIVE_RECEIVERS: function RECEIVE_RECEIVERS(state, _ref4) {
      var receivers = _ref4.receivers;

      state.receivers = receivers;
    },
    ADD_RECEIVER: function ADD_RECEIVER(state, _ref5) {
      var receiver = _ref5.receiver;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_AccountList_vue__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_AccountList_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_AccountList_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_ReceiverList_vue__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_ReceiverList_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_ReceiverList_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_NewReceiver_vue__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_NewReceiver_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_NewReceiver_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'app',
  components: {
    AccountList: __WEBPACK_IMPORTED_MODULE_0__components_AccountList_vue___default.a,
    ReceiverList: __WEBPACK_IMPORTED_MODULE_1__components_ReceiverList_vue___default.a,
    NewReceiver: __WEBPACK_IMPORTED_MODULE_2__components_NewReceiver_vue___default.a
  },
  data: function data() {
    return {
      currentView: 'default',
  ...
  methods: {
    openConsole: function openConsole() {
      if (cefCustomObject) cefCustomObject.showDevTools();
    }
  },
  created: function created() {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    createReceiver: function createReceiver() {
      ...
      var account = this.allAccounts[this.selectedAccount];
      var receiver = { streamId: this.streamId, token: account.apiToken, serverUrl: account.rootUrl };
      console.log(receiver);
      this.$store.commit('ADD_RECEIVER', { receiver: receiver });
      this.$emit('close');
    },
    closeMyself: function closeMyself() {
      this.$emit('close');
    }
  }
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SpeckleReceiver_vue__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SpeckleReceiver_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__SpeckleReceiver_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'ReceiverList',
  components: {
    SpeckleReceiver: __WEBPACK_IMPORTED_MODULE_0__SpeckleReceiver_vue___default.a
  },
  computed: {
    allReceivers: function allReceivers() {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_specklebrowser__ = __webpack_require__(45);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    receiverError: function receiverError(err) {
      this.errror = err;
    },
    liveUpdate: function liveUpdate(name, layers, objects, history) {
      ...
      this.mySpkReceiver.getObjects(function (objs) {
        ...
        if (typeof cefCustomObject != 'undefined') cefCustomObject.addObjects(JSON.stringify(objs));
      });
    },
    ...
    historyUpdate: function historyUpdate() {
      // todo
    },
  ...
  created: function created() {
    ...
    this.mySpkReceiver = new __WEBPACK_IMPORTED_MODULE_0_specklebrowser__["a" /* default */]({
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_material__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__store_Store_js__ = __webpack_require__(12);
...
// module
exports.push([module.i, ".receiver{margin-bottom:10px}", ""]);
...
// module
exports.push([module.i, ".paddedcard{margin-top:5px;margin-bottom:5px;width:90%;left:5%;overflow:hidden}", ""]);
...
// module
exports.push([module.i, "#app{box-sizing:border-box}#app,.accounts-tab .md-sidenav-content{background-color:#e6e6e6}.fade-enter-active,.fade-leave-active{transition:opacity .3s}.fade-enter,.fade-leave-to{opacity:0}", ""]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_event_emitter_es6__ = __webpack_require__(43);
...
class SpeckleReceiver extends __WEBPACK_IMPORTED_MODULE_0_event_emitter_es6___default.a {
  constructor( args ) {
    super() 
  ...
  handshake( callback ) {
    __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get( this.serverUrl, { headers : { 'speckle-token': this.token } } )
    .then( response => {
  ...
  getStream() {
    ...
    let self = this
    __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get( this.restEndpoint + '/streams/' + this.streamId + '/data/', { headers : { 'speckle-token': this.token,  'speckle-ws-id': this.wsSessionId } } )
    .then( response => {
      ...
      return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get( this.restEndpoint + '/streams/' + this.streamId, { headers : { 'speckle-token': this.token,  'speckle-ws-id': this.wsSessionId } } )
    })
    .then( response => {
      if( !response.data.success ) return this.emit( 'error', response.message )
  ...
  getObject( obj, callback ) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get( this.restEndpoint + '/geometry/' + obj.hash  )
      .then( response => { 
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SpeckleReceiver;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('md-card', {
    staticClass: "receiver paddedcard"
  }, [_c('md-progress', {
    directives: [{
      name: "show",
      rawName: "v-show",
  ...
  }), _vm._v(" "), _c('md-progress', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.objLoadProgress < 100),
      expression: "objLoadProgress < 100 "
    }],
    attrs: {
      "progress": _vm.objLoadProgress
    }
  }), _vm._v(" "), _c('md-card-header', [_c('div', {
    staticClass: "md-title"
  }, [_vm._v(_vm._s(_vm.name))])]), _vm._v(" "), _c('md-card-actions', [_c('md-button', {
    staticClass: "md-dense md-primaryx md-raised"
  }, [_vm._v("Refresh")]), _vm._v(" "), _c('md-button', {
    staticClass: "md-dense md-warn"
  }, [_vm._v("Remove")]), _vm._v(" "), _c('span', {
    staticStyle: {
      "flex": "1"
    }
  })], 1), _vm._v(" "), _c('md-card-content', _vm._l((_vm.layers), function(layer) {
    return _c('div', [_vm._v("\n        " + _vm._s(layer.name) + " | " + _vm._s(layer.objectCount) + " objects \n        ")])
  }))], 1)], 1)
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('md-card', {
    staticClass: "paddedcard",
    staticStyle: {
      "margin-bottom": "20px"
    }
  }, [_c('md-card-content', [_c('md-input-container', [_c('label', {
    attrs: {
      "for": "account"
    }
  }, [_vm._v("Account")]), _vm._v(" "), _c('md-select', {
    attrs: {
      "name": "account",
      "id": "account"
    },
  ...
  }, _vm._l((_vm.allAccounts), function(account, index) {
    return _c('md-option', {
      key: account.apiToken,
      attrs: {
        "value": index
      }
    }, [_vm._v(" " + _vm._s(account.serverName) + " "), _c('br'), _vm._v(" "), _c('small', [_vm._v(_vm._s(account.email) + " ")])])
  }))], 1), _vm._v(" "), _c('md-input-container', [_c('label', [_vm._v("Stream Id")]), _vm._v(" "), _c('md-input', {
    model: {
      value: (_vm.streamId),
      callback: function($$v) {
        _vm.streamId = $$v
    ...
    staticClass: "md-dense md-primary md-raised",
    nativeOn: {
      "click": function($event) {
        _vm.createReceiver($event)
      }
    }
  }, [_vm._v("Create Receiver")]), _vm._v(" "), _c('md-button', {
    staticClass: "md-dense md-warnxxx md-raisedxx",
    nativeOn: {
      "click": function($event) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('md-toolbar', {
    ...
    nativeOn: {
      "click": function($event) {
        _vm.showAddNewAccount = !_vm.showAddNewAccount
      }
    }
  }, [_c('md-icon', [_vm._v(_vm._s(_vm.showAddNewAccount ? "close" : "add"))]), _vm._v(" "), _c('md-tooltip', {
    attrs: {
      "md-direction": "bottom"
    }
  }, [_vm._v("Add a new account")])], 1), _vm._v(" "), _c('span', {
    staticStyle: {
      "flex": "1"
    }
  })], 1), _vm._v(" "), _c('md-card', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.showAddNewAccount),
      expression: "showAddNewAccount"
    }],
    staticClass: "paddedcard"
  }, [_c('md-card-header', [_c('div', {
    staticClass: "md-title"
  }, [_vm._v("Register a new account.")])]), _vm._v(" "), _c('md-card-content', [_c('md-input-container', [_c('label', [_vm._v("Server URL")]), _vm._v(" "), _c('md-input', {
    attrs: {
      "type": "string"
    }
  ...
  }, [_vm._v("Register")])], 1)], 1), _vm._v(" "), _vm._l((_vm.allAccounts), function(account) {
    return _c('md-card', {
      key: account.apiToken,
      staticClass: "paddedcard"
    }, [_c('md-card-header', [_c('div', {
      staticClass: "md-subhead"
    }, [_c('strong', [_vm._v(_vm._s(account.serverName))])]), _vm._v(" "), _c('div', {
      staticClass: "md-subhead"
    }, [_vm._v(_vm._s(account.apiToken))])]), _vm._v(" "), _c('md-card-content', [_vm._v("\n      " + _vm._s(account.email)), _c('br'), _vm._v(" "), _c('a', {
      attrs: {
        "href": account.rootUrl
      }
    }, [_vm._v(" " + _vm._s(account.rootUrl) + " ")])]), _vm._v(" "), _c('md-card-actions', [_c('md-button', {
      staticClass: "md-danger"
    }, [_vm._v("Ping")]), _vm._v(" "), _c('md-button', {
      staticClass: "md-warn"
    }, [_vm._v("Remove")])], 1)], 1)
  })], 2)
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "md-transparent md-dense",
    staticStyle: {
      "margin-bottom": "100px"
    }
  }, [_c('span', {
    ...
    staticClass: "md-icon-button md-right",
    nativeOn: {
      "click": function($event) {
        _vm.$refs.sidenav.toggle()
      }
    }
  }, [_c('md-icon', [_vm._v("person")])], 1), _vm._v(" "), _c('md-button', {
    staticClass: "md-icon-button md-right",
    nativeOn: {
      "click": function($event) {
        _vm.openConsole($event)
      }
    }
  }, [_c('md-icon', [_vm._v("bug_report")])], 1)], 1), _vm._v(" "), _c('md-sidenav', {
    ref: "sidenav",
    staticClass: "md-right accounts-tab"
  }, [_c('account-list')], 1), _vm._v(" "), (_vm.currentView === "default") ? _c('md-speed-dial', {
    staticClass: "md-fab-top-left ",
    attrs: {
      "md-open": "click",
      "md-direction": "bottom",
      "md-theme": "default"
  ...
  }, [_vm._v("close")]), _vm._v(" "), _c('md-icon', [_vm._v("add")]), _vm._v(" "), _c('md-tooltip', {
    attrs: {
      "md-direction": "bottom"
    }
  }, [_vm._v("Add a Speckle Client")])], 1), _vm._v(" "), _c('md-button', {
    staticClass: "md-fab md-primary md-mini md-clean",
    nativeOn: {
      "click": function($event) {
        _vm.createNewAccount = true
      }
    }
  }, [_c('md-icon', [_vm._v("cloud_download")]), _vm._v(" "), _c('md-tooltip', {
    attrs: {
      "md-direction": "bottom"
    }
  }, [_vm._v("New Receiver")])], 1), _vm._v(" "), _c('md-button', {
    staticClass: "md-fab md-primary md-mini md-clean",
    attrs: {
      "disabled": true
    }
  ...
  }, [_vm._v("cloud_upload")]), _vm._v(" "), _c('md-tooltip', {
    attrs: {
      "md-direction": "bottom"
    }
  }, [_vm._v("New Sender")])], 1)], 1) : _vm._e(), _vm._v(" "), _c('transition', {
    attrs: {
      "name": "fade"
    }
  }, [_c('new-receiver', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.createNewAccount === true),
      expression: "createNewAccount===true"
    }],
    on: {
      "close": function($event) {
        _vm.createNewAccount = false
      }
    }
  })], 1), _vm._v(" "), _c('receiver-list')], 1)
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.allReceivers.length === 0),
      expression: "allReceivers.length === 0"
    }],
    staticClass: "paddedcard",
    staticStyle: {
      "position": "relative"
    ...
    staticClass: "md-title"
  }, [_vm._v("There are no clients to show.")]), _vm._v(" "), _c('p', [_vm._v("You can add a new client by click on the big plus button above.")])]), _vm._v(" "), _vm._l((_vm.allReceivers), function(receiver) {
    return _c('speckle-receiver', {
      key: receiver.streamId,
      attrs: {
        "spkreceiver": receiver
      }
    })
  })], 2)
},staticRenderFns: []}
...
var update = __webpack_require__(5)("5d3a3896", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("566f271a", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("27bc1f59", content, true);
